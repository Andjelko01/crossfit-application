...
class PhysicalParameterControllerMapper {
    ...
    fun toPhysicalParameterDto(request: PhysicalParameterCreateRequest): PhysicalParameterDto = PhysicalParameterDto(
        date = request.date,
    ...
    fun toPhysicalParameterDto(request: PhysicalParameterUpdateRequest, existingDto: PhysicalParameterDto): PhysicalParameterDto = existingDto.copy(
    ...
    fun toMeasurementsDto(request: MeasurementsCreateRequest): MeasurementsDto = MeasurementsDto(
    ...
    fun toMeasurementsDto(request: MeasurementsUpdateRequest, existingDto: MeasurementsDto): MeasurementsDto = existingDto.copy(
    ...
    fun toSkinfoldsDto(request: SkinfoldsCreateRequest): SkinfoldsDto = SkinfoldsDto(
    ...
    fun toSkinfoldsDto(request: SkinfoldsUpdateRequest, existingDto: SkinfoldsDto): SkinfoldsDto = existingDto.copy(
        id = request.id ?: existingDto.id,
