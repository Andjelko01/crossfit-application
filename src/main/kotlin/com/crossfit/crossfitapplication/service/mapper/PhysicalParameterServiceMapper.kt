...
class PhysicalParameterServiceMapper {
    ...
    fun toPhysicalParameterEntity(physicalParameterDto: PhysicalParameterDto, member: Member): PhysicalParameter = PhysicalParameter(
    ...
    fun toMeasurementsEntity(measurementsDto: MeasurementsDto): Measurements = Measurements(
    ...
    fun toSkinfoldsEntity(skinfoldsDto: SkinfoldsDto): Skinfolds = Skinfolds(
        id = skinfoldsDto.id,
    ...
    fun toPhysicalParameterDto(entity: PhysicalParameter): PhysicalParameterDto = PhysicalParameterDto(
        id = entity.id,
        date = entity.date,
    ...
    fun toMeasurementsDto(entity: Measurements): MeasurementsDto = MeasurementsDto(
        id = entity.id,
    ...
    fun toSkinfoldsDto(entity: Skinfolds): SkinfoldsDto = SkinfoldsDto(
        id = entity.id,
